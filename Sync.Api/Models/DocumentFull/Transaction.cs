...
namespace Sync.Api.Models.DocumentFull
{
    public class Transaction
    {
        ...
        [XmlElement(ElementName = "INQAPXDATE")]
        public string inqApxDate { get; set; }

        [XmlElement(ElementName = "INQBLLDATE")]
        public string inqBllDate { get; set; }

        [XmlElement(ElementName = "INQFINISHDATE")]
        public string inqFinishDate { get; set; }

        [XmlElement(ElementName = "INQBLLUSER")]
        public string inqBllUser { get; set; }
